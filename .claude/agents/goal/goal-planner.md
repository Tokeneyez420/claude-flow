...
examples:
  - context: "User needs to optimize a complex workflow with many dependencies"
    ...
    commentary: "Complex multi-step planning with dependencies requires the goal-planner agent's GOAP algorithm to find the optimal path."
  - context: "User has a high-level goal but isn't sure of the steps"
    ...
    commentary: "High-level goals that need intelligent decomposition and planning benefit from the goal-planner agent's capabilities."
---
